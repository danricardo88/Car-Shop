...
// import CarController from '../../../src/Controllers/CarControl';
// import CarService from '../../../src/Services/CarService';

// import { carOutput, carInput, genericError } from '../../utils/mockCar';
...
//     sinon.stub(CarService.prototype, 'getId').resolves(carOutput);
//     const Controller = new CarController(mReq, mRes, mNext);
...
//       sinon.stub(CarService.prototype, 'getId').throws(genericError);
//       const Controller = new CarController(mReq, mRes, mNext);
//       await Controller.findById();
